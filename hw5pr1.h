...
public:
  ...
  MyRide(string file) : file_name(file) {}; //with file
  //accesor functions
  ...
  void addCustomer()  {
    ...
    string name;                    //to store the customers name
    cout << "What is your first name? ";  //promt
    cin >> name;
    ...
    //comfirm to the user
    cout << endl << name << " has been added into the system" << endl << endl;
  }
